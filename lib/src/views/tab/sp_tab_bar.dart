...
import 'package:flutter_stipop/l10n.dart';
import 'package:flutter_stipop/src/client/models/type.dart';
import 'package:flutter_stipop/src/providers/tab_provider.dart';
import 'package:provider/provider.dart';

class SPTabBar extends StatefulWidget {
...
class _GiphyTabBarState extends State<SPTabBar> {
  ...
  void didChangeDependencies() {
    // Set TabList
    final l = SPUILocalizations.labelsOf(context);
    _tabs = [
      if (widget.showGIFs)
